...
./bin/int2svg.exe ../INTS_MEXICO/mge2013v6_2.int 3 3 0 900 500 ./salidas900/0.svg
cd salidas900
find ./ -size 0b -delete
...
./bin/int2svg.exe ../INTS_MEXICO/mge2013v6_2.int 3 3 0 297 380 ./salidas297/0.svg
cd salidas297
find ./ -size 0b -delete
...
cp salidas900/* $HOME/NetBeansProjects/nusic/NUSiC/mapasng/origen/900/ -v
cp salidas950/* $HOME/NetBeansProjects/nusic/NUSiC/mapasng/origen/950/ -v
cp salidas297/* $HOME/NetBeansProjects/nusic/NUSiC/mapasng/origen/297/ -v
