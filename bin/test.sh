...
./bin/int2svg.exe ../INTS_MEXICO/mgm2013v6_2.int 3 4 $i 900 500 ./salidas900/$i.svg ./bin/excepcion_mun.txt 1
...
./bin/int2svg.exe ../INTS_MEXICO/mgm2013v6_2.int 3 4 $i 297 380 ./salidas297/$i.svg ./bin/excepcion_mun.txt 1
